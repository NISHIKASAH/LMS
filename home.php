    ...
    <div class="row">
        ...
        >
          ...
          <div class="two-columns-grid">
            <div class="starters">
              ...
              <div class="starter">
                <div class="starter-header">
                  <h3>School of Electrical & Electronices</a></h3>
                </div>
                <p class="menu-paragraph">
            ...
            <div class="mains">
              ...
              <div class="starter">
                <div class="starter-header">
                  <h3>school of bio &chemical</a></h3>
      ...
      <form action="index.php" method="post">
        <section class="book" id="reservation">
          <div class="container-fluid">
            <div class="book-card">
              <h2 class="section-title book-title">Welcome </h2>
              <h3 class="section-subtitle">
              <?php echo $name;?>
              </h3>
              <div class="two-columns-grid">
                <div class="form-group">
                <a href="issueBook.php" class="Command"><h1>Issue Book</h1></a>
                </div>
                <div class="form-group">
                <a href="request.php" class="Command"><h1>Request New Books</h1></a>
                </div>
              </div>

              <div class="two-columns-grid">
                <div class="form-group">
                <a href="changePassword.php" class="Command"><h1>Change Password</h1></a>
                </div>
                <div class="form-group">
                <a href="logout.php" class="Command"><h1>Logout</h1></a>
                </div>
              </div>
